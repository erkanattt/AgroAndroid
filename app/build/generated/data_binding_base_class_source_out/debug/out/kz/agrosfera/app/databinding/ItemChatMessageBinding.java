...
public final class ItemChatMessageBinding implements ViewBinding {
  ...
  private ItemChatMessageBinding(@NonNull FrameLayout rootView, @NonNull TextView textMessage) {
  ...
  public static ItemChatMessageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemChatMessageBinding((FrameLayout) rootView, textMessage);
    }
